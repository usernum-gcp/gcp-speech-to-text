...
def transcribe_gcs_with_word_time_offsets(gcs_uri, index=random.randint(1,9223372036854775807)):
    ...
    with open(csv_file_name, 'w') as csvfile:
            fieldnames = ['call_id', 'word', 'start_time','end_time','confidence','sentence']
            ...
            for result in result.results:
                ...
                for word_info in alternative.words:
                    ...
                    start_time = word_info.start_time
                    end_time = word_info.end_time
                    message('call_id: {}, word: {}, start_time: {}, end_time: {}, sentence: {}, confidence: {}'.format(
                    index,
                    word.encode('utf-8'),
                    start_time.seconds + start_time.nanos * 1e-9,
                    end_time.seconds + end_time.nanos * 1e-9,
                    ...
                    'confidence': alternative.confidence,'sentence':alternative.transcript.encode('utf-8')})
